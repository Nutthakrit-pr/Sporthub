...
try {
    $stmt = $db->prepare("SELECT * FROM sp_transaction WHERE username = :username");
...
<nav style="width: 100%;
    ...
    <div style="display: flex; align-items: center;">
        <!-- Admin Text -->
        <h1 style="font-size: 2vw; color: white; margin-bottom: 9px; font-weight: bold">User</h1>
        <!-- sportHUB Logo -->
        <a href="home.php">
                ...
                <table id="studentsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <input type="text" class="operation-field" value="<?php echo htmlspecialchars($u['operation']); ?>" disabled>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <?php if ($_SESSION['username'] === $u['username']): ?>
                                        <!-- Show Edit and Delete buttons if the logged-in user is the owner of the transaction -->
                                    ...
                                    <?php else: ?>
                                        <!-- Hide the Edit and Delete buttons if the user is not the owner of the transaction -->
